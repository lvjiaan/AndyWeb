...
/**
 * <p>batchKnowledgeAgencyResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="batchKnowledgeAgencyResponse">
 *   &lt;complexContent>
...
@XmlType(name = "batchKnowledgeAgencyResponse", propOrder = {
    "_return"
})
public class BatchKnowledgeAgencyResponse {
